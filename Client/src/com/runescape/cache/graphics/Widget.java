...
public class Widget {
	...
	public static void load(FileArchive interfaces, GameFont textDrawingAreas[], FileArchive graphics) {
		...
		levelUpInterfaces();
			...
			/** CUSTOM WIDGETS **/
		AdditionalWidget.decode(textDrawingAreas);
		SettingsWidget.decode(textDrawingAreas);
	...
	public static void equipmentTab(GameFont[] wid) {
		...
		addHoverButton_sprite_loader(27660, 498, 40, 40, "Call follower", -1, 27661, 1);
		addHoveredButton_sprite_loader(27661, 499, 40, 40, 27662);
