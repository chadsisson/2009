...
public final class ItemDefinition {
	...
	public boolean isDialogueModelCached(int gender) {
		...
		if (model_1 == -1)
			return true;
		boolean cached = true;
		if (!Model.method463(model_1))
			cached = false;
		if (model_2 != -1 && !Model.method463(model_2))
			cached = false;
		return cached;
	}
	...
	public Model getChatEquipModel(int gender) {
		...
		if (dialogueModel == -1)
			return null;
		Model dialogueModel_ = Model.method462(dialogueModel);
		if (dialogueHatModel != -1) {
			Model hatModel_ = Model.method462(dialogueHatModel);
		...
		if (modified_model_colors != null) {
			for (int i1 = 0; i1 < modified_model_colors.length; i1++)
				dialogueModel_.method476(modified_model_colors[i1], original_model_colors[i1]);
	...
	public boolean isEquippedModelCached(int gender) {
		...
		if (primaryModel == -1)
			return true;
		boolean cached = true;
		if (!Model.method463(primaryModel))
			cached = false;
		if (secondaryModel != -1 && !Model.method463(secondaryModel))
			cached = false;
		if (emblem != -1 && !Model.method463(emblem))
			cached = false;
		return cached;
	}
	...
	public Model getEquippedModel(int gender) {
		...
		if (primaryModel == -1)
			return null;
		Model primaryModel_ = Model.method462(primaryModel);
		if (secondaryModel != -1)
			if (emblem != -1) {
				Model secondaryModel_ = Model.method462(secondaryModel);
				Model emblemModel = Model.method462(emblem);
				Model models[] = { primaryModel_, secondaryModel_, emblemModel };
				primaryModel_ = new Model(3, models);
			} else {
				Model model_2 = Model.method462(secondaryModel);
				Model models[] = { primaryModel_, model_2 };
				primaryModel_ = new Model(2, models);
			}
		if (gender == 0 && equipped_model_male_translation_y != 0)
			primaryModel_.method475(0, equipped_model_male_translation_y, 0);
		if (gender == 1 && equipped_model_female_translation_y != 0)
			primaryModel_.method475(0, equipped_model_female_translation_y, 0);
		
		if (modified_model_colors != null) {
			for (int i1 = 0; i1 < modified_model_colors.length; i1++)
				primaryModel_.method476(modified_model_colors[i1], original_model_colors[i1]);
	...
	public static ItemDefinition lookup(int itemId) {
		...
		if (itemId == 4724 || itemId == 4726 || itemId == 4728 || itemId == 4730 || itemId == 4753 || itemId == 4755 || itemId == 4757 || itemId == 4759 || itemId == 4745 || itemId == 4747 || itemId == 4749 || itemId == 4751 ||
			itemId == 4708 || itemId == 4710 || itemId == 4712 || itemId == 4714 || itemId == 4732 || itemId == 4734 || itemId == 4736 || itemId == 4738 || itemId == 4716 || itemId == 4718 || itemId == 4720 || itemId == 21018 || itemId == 21021 || itemId == 21024 || itemId == 4722) {
	...
	public Model getModel(int stack_size) {
		...
		if (model != null)
			return model;
		model = Model.method462(inventory_model);
		if (model == null)
			return null;
		if (model_scale_x != 128 || model_scale_y != 128 || model_scale_z != 128)
			model.method478(model_scale_x, model_scale_z, model_scale_y);
		if (modified_model_colors != null) {
			for (int l = 0; l < modified_model_colors.length; l++)
				model.method476(modified_model_colors[l], original_model_colors[l]);

		}
		int lightInt = 64 + light_intensity;
		int lightMag = 768 + light_mag;
		model.method479(lightInt, lightMag, -50, -10, -50, true);
	...
	public Model getUnshadedModel(int stack_size) {
		...
		Model model = Model.method462(inventory_model);
		if (model == null)
			return null;
		if (modified_model_colors != null) {
			for (int colorPtr = 0; colorPtr < modified_model_colors.length; colorPtr++)
				model.method476(modified_model_colors[colorPtr], original_model_colors[colorPtr]);
