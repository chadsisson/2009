...
public final class Configuration {
	 ...
	 */
	public static String server_address = "127.0.0.1"; // Put ip here           localhost
	/**
	...
	public static final String LOCAL_CACHE_DIRECTORY = "./Cache/";//System.getProperty("user.home") + File.separator + "MistPSV"+CLIENT_VERSION+"/";

	public static final String CACHE_DIRECTORY = System.getProperty("user.home") + File.separator + "MistPSV"+CLIENT_VERSION+"/";
	 ...
	 */
	public static final String CLIENT_NAME = "Emerald";
