...
public class ButtonClickPacketListener implements PacketListener {
	...
	public void handleMessage(Player player, Packet packet) {
		...
		case VIEW_IGNORE_LIST:
			player.getPacketSender().sendTabInterface(8, 5715);
			break;
			
		case VIEW_FRIENDS_LIST:
			player.getPacketSender().sendTabInterface(8, 5065);
			break;		
			/** NEED TO SHORTEN THE BUTTON END **/
			
			
		case 42702:
			player.getPacketSender().sendTabInterface(11, 42600);
			break;
			
		case 42605:
			player.getPacketSender().sendTabInterface(11, 42700);
			break;
	...
	private static final int TOGGLE_RUN_ENERGY_SETTINGS = 42615;
	...
	private static final int VIEW_IGNORE_LIST = 30000;
	private static final int VIEW_FRIENDS_LIST = 30030;
}
