...
public class Player extends Character {
	...
	public void onTick() {
		...
		TotalPlayTime++;
			...
			/** Game Panel Informations **/
		getPacketSender().
		sendString(7383, "Time: @gre@" + Misc.getTime()).
		sendString(7339, "Uptime: @gre@" + Misc.getUpTime()).
		sendString(7338, "Players: @gre@" + World.getPlayers().size()).
		sendString(7340, "Rank: @gre@" + getRights().name()).
		sendString(7342, "Total Playtime: @gre@" + Misc.getHoursPlayed(TotalPlayTime));
	...
	public void onLogin() {
		...
		getPacketSender().sendMessage("Welcome to Emerald.");
